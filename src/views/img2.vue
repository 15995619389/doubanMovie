...
<style scoped>
  ...
  .myCropper-container .myCropper-preview .myCropper-preview-3 {
    ...
    .myCropper-container .myCropper-preview .myCropper-preview-1 img{
       width: 100%;
      height: 100%;
  }
    .myCropper-container .myCropper-preview .myCropper-preview-2 img{
       width: 100%;
      height: 100%;
  }
  .myCropper-container .myCropper-preview .myCropper-preview-3 img{
       width: 100%;
      height: 100%;
  }
  /* // 按钮 */
